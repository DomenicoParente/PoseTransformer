...
# DataLoader for TartanAir Dataset by Carnegie Mellon University
class TartanAirDataset(Dataset):
    ...
    def __init__(self, scenes_dir, n_segment, frame_template, label_template, n_scenes,
...
class TartanAirDataset_v2(TartanAirDataset):
...
class TartanAirDataset_overlapping(TartanAirDataset):
